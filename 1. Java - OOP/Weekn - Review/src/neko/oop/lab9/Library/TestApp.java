...
public class TestApp {
    public static void main(String[] args) throws ParseException {
        Item i1 = new Book("Java", 2019, 1000);
        Item i2 = new Book("C++", 2018, 2000);

        Student s1 = new Student("Ivan", "Ivanov", 1);
        Student s2 = new Student("Petr", "Petrov", 2);
        ...
        System.out.println(l.getLongestRent().getStudent());
        System.out.println(l.getLongestRent().getItem());
    }
}
